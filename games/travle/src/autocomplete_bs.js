...
class Autocomplete {
    constructor(field, options) {
        ...
        const dropdown = ce(`<div class="dropdown-menu dropdown-menu-dark"></div>`);
        ...
        field.addEventListener('keydown', (e) => {
            ...
            if (e.keyCode === 13) { // Enter -> autocomplete
                ...
                else if (this.dropdown._menu.children.length >= 1) {
                    this.field.value = firstChildVal;
                    this.renderIfNeeded();
                }
            }
        });
