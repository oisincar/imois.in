...
consider powers of it instead of repeatingly cascading.
...
is over a million itterations.

Funnily, we both came up with this idea cooincidentally within a few minutes of eachother.
...
Several other widths are suprisingly solvable, 10 (other than above), 81, and many more.
...
relation to other areas of celular automatia.
