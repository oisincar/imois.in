...
export function setup() {
    var ret = wasm.setup();
    return PhysicsStuff.__wrap(ret);
}
...
export class PhysicsStuff {
    ...
    static __wrap(ptr) {
        const obj = Object.create(PhysicsStuff.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_physicsstuff_free(ptr);
    }
    /**
    */
    step() {
        wasm.physicsstuff_step(this.ptr);
    }
    /**
    * @returns {string}
    */
    get_info() {
        try {
            ...
            wasm.physicsstuff_get_info(retptr, this.ptr);
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('run_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_alert_69e4164afc46ff94 = function(arg0, arg1) {
